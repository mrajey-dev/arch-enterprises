        ...
        <div class="content-header-modern">
          <div class="header-left">
            ...
            <div>
              ...
              <p class="subtitle-modern">Track your pending leave requests</p>
            </div>
          </div>
          <div class="stats-badge-header">
            <i class="fas fa-chart-line"></i>
            <span>{{ leaveRequests.length }} Pending</span>
          </div>
        </div>
        ...
        <div class="table-wrapper-premium">
          <div class="table-header">
            <div class="section-title-modern">
              ...
              <span>Pending Leave Records</span>
            </div>
            ...
            <table class="leave-table-premium">
              ...
              <tbody>
                <tr v-for="leave in leaveRequests" :key="leave.id" class="leave-row">
                  ...
                  <td>
                    <span class="status-badge-premium pending">
      ...
      try {
        ...
        if (this.user && this.user.name) {
          this.leaveRequests = data.filter(
            leave => leave.name === this.user.name && leave.status === 'Pending'
          );
        } else {
          this.leaveRequests = [];
        }
