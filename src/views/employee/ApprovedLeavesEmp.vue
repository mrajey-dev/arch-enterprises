        ...
        <div class="content-header-modern">
          <div class="header-left">
            ...
            <div>
              ...
              <p class="subtitle-modern">View all your approved leave requests</p>
            </div>
          </div>
          <div class="stats-badge-header">
            <i class="fas fa-calendar-check"></i>
            <span>{{ leaveRequests.length }} Approved</span>
          </div>
        </div>
        ...
        <div class="table-wrapper-premium">
          <div class="table-header">
            <div class="section-title-modern">
              ...
              <span>Approved Leave Records</span>
            </div>
            ...
            <table class="leave-table-premium">
              ...
              <tbody>
                <tr v-for="leave in leaveRequests" :key="leave.id" class="leave-row">
                  ...
                  <td>
                    <span class="status-badge-premium approved">
                ...
                <tr v-if="leaveRequests.length === 0" class="empty-row">
                  <td colspan="6">
                    <div class="empty-state-premium">
                      ...
                      <p>You don't have any approved leave requests yet</p>
                    </div>
                  </td>
                </tr>
              </tbody>
      ...
      try {
        ...
        if (this.user && this.user.name) {
          this.leaveRequests = data.filter(
            leave => leave.name === this.user.name && leave.status === 'Approved'
          );
        } else {
          this.leaveRequests = [];
        }
