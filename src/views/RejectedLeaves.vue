        ...
        <div class="content-header-modern">
          <div class="header-left">
            ...
            <div>
              ...
              <p class="subtitle-modern">View all rejected leave requests</p>
            </div>
          </div>
          <div class="stats-badge-header rejected">
            <i class="fas fa-ban"></i>
            <span>{{ sortedLeaves.length }} Rejected</span>
          </div>
        </div>
        ...
        <div class="stats-bar">
          ...
          <div class="stat-card">
            ...
            <div class="stat-info">
              ...
              <span class="stat-label">Total Days Rejected</span>
            </div>
          </div>
          <div class="stat-card">
            <i class="fas fa-chart-line"></i>
            <div class="stat-info">
              <span class="stat-value">{{ thisMonthRejections }}</span>
        ...
        <div v-else class="table-wrapper-premium">
          <div class="table-header">
            ...
            <div class="table-info">
              ...
              <span>{{ sortedLeaves.length }} records</span>
            </div>
          </div>
